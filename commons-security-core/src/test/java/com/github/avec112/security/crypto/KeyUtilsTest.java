...
class KeyUtilsTest extends BouncyCastleProviderInitializer {
    ...
    void testGenerateEcKeyPairWithSpecificCurve() throws Exception {
        KeyPair keyPair = KeyUtils.generateEcKeyPair(com.github.avec112.security.crypto.ecc.EccCurve.SECP384R1);
    ...
    void testGenerateEcKeyPairThrowsExceptionForEd25519() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            KeyUtils.generateEcKeyPair(com.github.avec112.security.crypto.ecc.EccCurve.ED25519);
        });
