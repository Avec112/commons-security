 ...
 *
 * The {@code RsaKeySize} enum provides a set of constants for commonly used key sizes in bits,
...
public enum RsaKeySize {
    BIT_2048(2048),
    BIT_3072(3072), // default
    BIT_4096(4096);
    private final int keySize;

    /**
     * Retrieves the {@code RsaKeySize} enumeration constant corresponding to the specified key size.
     * The method checks the predefined key sizes in the {@link RsaKeySize} enum and returns the matching constant.
     ...
     * @return the {@link RsaKeySize} constant that matches the specified key size.
     * @throws IllegalArgumentException if the specified key size is not supported.
     */
    public static RsaKeySize getKeySize(int keySize) {
        return Stream.of(RsaKeySize.values())
