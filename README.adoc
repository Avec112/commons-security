...
[source,java]
----
include::src/main/java/com/github/avec112/security/crypto/digest/DigestAlgorithm.java[tag=algorithms]
----
...
----
include::src/main/java/com/github/avec112/security/crypto/password/PasswordEncoderType.java[tag=algorithms]
----
