...
* *Symmetric encryption* and decryption with same key. `AES/CTR` and `AES/GCM` is supported.
...
[source,java]
----
include::src/main/java/io/avec/security/crypto/digest/DigestAlgorithm.java[tag=hashing-algorithms]
----
...
----
include::src/main/java/io/avec/security/crypto/password/PasswordEncoderType.java[lines=3..]
----
